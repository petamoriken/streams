...
var ReadableStream = function () {
  ...
  (0, _createClass3.default)(ReadableStream, [{
    ...
    value: function pipeTo(dest) {
      ...
      var _resolvePipeToPromise = void 0;
      var _rejectPipeToPromise = void 0;
      ...
      var _lastRead = void 0;
      var _lastWrite = void 0;
      var _allWrites = void 0;
      ...
      function handleReadValue(value) {
        ...
        _allWrites = _promise2.default.all([_allWrites, _lastWrite]);
      ...
      function doPipe() {
        ...
        _promise2.default.all([_lastRead, _writer.ready]).then(function (_ref5) {
